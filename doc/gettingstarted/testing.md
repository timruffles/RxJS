...
Let's face it, testing asynchronous code is a pain.  In JavaScript, with so many asynchronous things to coordinate, testing can be hard to wrap your mind around.  We feel the Reactive Extensions for JavaScript makes testing asynchronous more manageable.
